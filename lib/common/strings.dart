...
const Map<TypistType, String> noColorHint = {
  TypistType.typeColor: 'Type a color',
  TypistType.textToColor: 'Type anything',
};
...
const String textToColorDrawerTitle = 'Type Anything';
const String textToColorDrawerSubtitle = 'Type a name, title, quote, or sentence and get a color';
