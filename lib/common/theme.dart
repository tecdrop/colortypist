...
ThemeData appTheme(Brightness brightness) {
  ...
  return ThemeData.from(
    colorScheme: ColorScheme.fromSeed(
      ...
      // So far used for floating action buttons
      secondary: lightWhiteDarkBlack,
      onSecondary: lightBlackDarkWhite,
    ...
    // So far used for the active color of the radio tiles in the Settings screen
    toggleableActiveColor: lightBlackDarkWhite,
...
TextStyle listTileSubtitleStyle(BuildContext context, {Color? textColor}) {
  return Theme.of(context).textTheme.caption!.copyWith(color: textColor);
}
