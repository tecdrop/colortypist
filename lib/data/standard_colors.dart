...
/// The standard colors map and functions to parse and return standard color names.

import 'dart:ui';

/// Parses [source] as a standard color name and returns the [Color] value, or null if the [source]
...
/// Returns the name of the given [color] from the standard color map, or null if the [color] is not
/// a standard color.
@override
...
// cSpell:words gainsboro, rebeccapurple

/// Provides a map of [Color] constants corresponding to the CSS color names.
///
/// See [CSS Color Module Level 4](https://www.w3.org/TR/css-color-4/#named-colors).
