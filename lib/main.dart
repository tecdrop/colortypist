    ...
    return MaterialApp(
      ...
      routes: <String, Widget Function(BuildContext)>{
        ...
        constants.typeColorRoute: (BuildContext context) => const TypistScreen(
              typistType: TypistType.typeColor,
            ),

        // The Typist route in Text To Color mode
        constants.textToColorRoute: (BuildContext context) => const TypistScreen(
              typistType: TypistType.textToColor,
            ),
